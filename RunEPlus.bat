...
:                  "nolimit" if unlimited (used when calling readVarsESO)
 ...
 set program_path=C:\EnergyPlusV9-4-0\
 set program_name=EnergyPlus.exe
 set input_path=C:\Users\mosta\Desktop\RL_Adaptive model_eta\in\
 set output_path=C:\Users\mosta\Desktop\RL_Adaptive model_eta\out\
 ...
 set weather_path=C:\Users\mosta\Desktop\RL_Adaptive model_eta\in\
 set pausing=N
 set maxcol=250
